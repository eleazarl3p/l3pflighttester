            ...
            onPressed: () async {
              if (_formKey.currentState!.validate()) {
                Map<String, dynamic> tempFlight = {
                  ...
                  'hasTopCrotchPost': templateFlight['topCrotch'],

                  //
                  "bottomCrotch": templateFlight['bottomCrotch'],
                  "bottomCrotchLength": btcController.text,
                  'hasBottomCrotchPost': templateFlight['hasBottomCrotchPost'],
                  //
                              ...
                              BlockContainer(
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        const MyTableCol(name: "Has Post"),
                                        MyTableCell(
                                          Checkbox(
                                      ...
                                      MyTableCell(
                                        Focus(
                                          child: TextFormField(
                                            ...
                                            style:
                                                TextStyle(fontSize: 14, color: templateFlight['topCrotch'] ? Colors.black : Colors.blueGrey.shade50),
                                          ),
                                          onFocusChange: (value) {
                                            if (!value) {
